...
namespace Учебное_Заведение.model
{
    ...
    public partial class УчебноеЗаведениеEntities : DbContext
    {
        private static УчебноеЗаведениеEntities _context;
        public static УчебноеЗаведениеEntities Getcontext()
        {
            if( _context == null)
            {
                _context = new УчебноеЗаведениеEntities();
            }
            return _context;
        }
        public УчебноеЗаведениеEntities()
            : base("name=УчебноеЗаведениеEntities")
        {
        }
